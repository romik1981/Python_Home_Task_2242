"""
1) Написать функцию thesaurus(), принимающую в качестве аргументов имена сотрудников и возвращающую словарь,
...
print(thesaurus("Иван", "Мария", "Петр", "Илья", "Александр", "Борис", "Олег"))
